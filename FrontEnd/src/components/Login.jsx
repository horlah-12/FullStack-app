            ...
            <div className="auth-card-wrapper">
                <div className="auth-card">
                    ...
                    <div className="auth-header">
                        <h1 className="auth-title">SOLUTION C&S MEDIA TASK MANAGER</h1>
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        {/* Submit Button */}
                        <button type="submit" disabled={isLoading} className="auth-button login-button">
                    ...
                    <div className="auth-bottom">
                        <p className="auth-bottom-text">
                            New User?{' '}
                            <Link to="/register" className="auth-bottom-link">Register</Link>
                        </p>
                    </div>
                </div>
